...
import br.com.davi.chiquinhomaquinas.relatorios.RelatorioLucro;
...
public class LucroRelatorio extends javax.swing.JFrame {

    public LucroRelatorio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório dos Lucros Totais");
        ...
        labelTitulo.setText("Relatório dos Lucros Totais");
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição", "Endereço", "Situação", "Data", "Pessoa", "Valor"
            }
        ) {
    ...
    private void botaoGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoGerarActionPerformed
        ...
        try {
            ...
            if (sList.size() != 0) {
                ...
                rl.emitirRelatorio(sList);
            } else {
                JOptionPane.showMessageDialog(null, "Nenhum Lucro foi encontrado!", "Aviso", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            JOptionPane.showMessageDialog(this, "Erro ao consultar Lucro por Periodo: " + e.getMessage());
        }
    ...
    public void preencheTabela(List<Servico> sList) {
        if (sList != null) {
            String[] strSVet = new String[]{"Código", "Descrição", "Endereço", "Situação", "Data", "Pessoa", "Valor"};
            String[][] strSMat = new String[sList.size()][7];
            DateParse dp = new DateParse();
            ...
            for (int i = 0; i < sList.size(); i++) {
                ...
                strSMat[i][0] = s.getCDSERVICO() + "";
                strSMat[i][1] = s.getDESCRICAO();
                strSMat[i][2] = s.getENDERECO();
                if (s.getSITUACAO().equals("P")) {
                    strSMat[i][3] = "Paga";
                } else if (s.getSITUACAO().equals("N")) {
                    strSMat[i][3] = "Não Paga";
                }
                strSMat[i][4] = dp.dateToString(s.getDATAPAGAMENTO());
                try {
                    if (cfControle.consultarPorId(s.getCDPESSOAFK()) != null) {
                        strSMat[i][5] = cfControle.consultarPorId(s.getCDPESSOAFK()).getNOME();
                    } else {
                        strSMat[i][5] = cjControle.consultarPorId(s.getCDPESSOAFK()).getNOME();
                    }

                } catch (DaoException e) {
                    JOptionPane.showMessageDialog(this, e.getMessage());
                }
                strSMat[i][6] = "R$" + Double.toString(s.getPRECOTOTAL());
                total = total + s.getPRECOTOTAL();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LucroRelatorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LucroRelatorio().setVisible(true);
            }
        });
    }
