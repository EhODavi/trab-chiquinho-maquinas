...
public class FuncionarioConsultarTrab1 extends javax.swing.JDialog {
    ...
    public FuncionarioConsultarTrab1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void preencheTabela(List<Funcionario> fList) {
        if (fList != null) {
            ...
            for (int i = 0; i < fList.size(); i++) {
                ...
                strTDMat[i][3] = f.getTELEFONE();
                strTDMat[i][4] = f.getEMAIL();
                strTDMat[i][5] = f.getCPF();
                strTDMat[i][6] = Double.toString(f.getVALORHORA());
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncionarioConsultarTrab1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FuncionarioConsultarTrab1 dialog = new FuncionarioConsultarTrab1(new javax.swing.JFrame(), true);
