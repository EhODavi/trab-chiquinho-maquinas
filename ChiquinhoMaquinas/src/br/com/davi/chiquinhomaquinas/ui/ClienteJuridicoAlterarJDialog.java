...
public class ClienteJuridicoAlterarJDialog extends javax.swing.JDialog {
    ...
    public ClienteJuridicoAlterarJDialog(java.awt.Frame parent, boolean modal, int CDPESSOA) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Alteração de Cliente Jurídico");
        ...
        labelTitulo.setText("Alteração de Cliente Jurídico");
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
        ...
        this.cj.setNOME(tfNome.getText());
        this.cj.setTELEFONE(tfTelefoneCelular.getText());
        this.cj.setENDERECO(tfEndereco.getText());
        this.cj.setEMAIL(tfEmail.getText());
        this.cj.setCNPJ(ftfCNPJ.getText().substring(0, 2) + ftfCNPJ.getText().substring(3, 6) + ftfCNPJ.getText().substring(7, 10) + ftfCNPJ.getText().substring(11, 15) + ftfCNPJ.getText().substring(16, 18));
        this.cj.setINSCRICAOESTADUAL(ftfInscricaoEstadual.getText().substring(0, 3) + ftfInscricaoEstadual.getText().substring(4, 7) + ftfInscricaoEstadual.getText().substring(8, 11) + ftfInscricaoEstadual.getText().substring(12, 16));
        try {
            cjControle.alterar(this.cj);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
        JOptionPane.showMessageDialog(null, "Alteração de Cliente Jurídico realizado com sucesso!", "Aviso", JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteJuridicoAlterarJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ClienteJuridicoAlterarJDialog dialog = new ClienteJuridicoAlterarJDialog(new javax.swing.JFrame(), true, 0);
