...
public class FuncionarioVisualizarJDialog extends javax.swing.JDialog {

    public FuncionarioVisualizarJDialog(java.awt.Frame parent, boolean modal, int CDPESSOA) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Visualização de Funcionário");
        ...
        labelTitulo.setText("Visualização de Funcionário");
        ...
        painelPrincipal.add(labelAsterisco4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 180, 10, -1));
        ...
        painelPrincipal.add(labelAsterisco6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncionarioVisualizarJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FuncionarioVisualizarJDialog dialog = new FuncionarioVisualizarJDialog(new javax.swing.JFrame(), true, 0);
