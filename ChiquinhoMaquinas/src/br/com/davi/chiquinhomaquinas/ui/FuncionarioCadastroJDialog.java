...
public class FuncionarioCadastroJDialog extends javax.swing.JDialog {
    ...
    public FuncionarioCadastroJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public FuncionarioCadastroJDialog(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ftfCPF.setPreferredSize(new java.awt.Dimension(65, 30));
        ...
        tfValor.setPreferredSize(new java.awt.Dimension(65, 30));
        ...
        painelPrincipal.add(labelAsterisco5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 180, 20, -1));
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        ...
        f.setTELEFONE(tfTelefoneCelular.getText());
        f.setENDERECO(tfEndereco.getText());
        f.setEMAIL(tfEmail.getText());
        f.setVALORHORA(Double.parseDouble(tfValor.getText()));
        f.setCPF(ftfCPF.getText().substring(0, 3) + ftfCPF.getText().substring(4, 7) + ftfCPF.getText().substring(8, 11) + ftfCPF.getText().substring(12, 14));
        try {
            f.setCDPESSOA(fControle.inserir(f));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
        JOptionPane.showMessageDialog(null, "Cadastro de Funcionário realizado com sucesso!", "Aviso", JOptionPane.INFORMATION_MESSAGE);
        this.f = f;
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuncionarioCadastroJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FuncionarioCadastroJDialog dialog = new FuncionarioCadastroJDialog(new javax.swing.JFrame(), true);
