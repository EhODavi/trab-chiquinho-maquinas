...
public class DespesaCadastroJDialog extends javax.swing.JDialog {
    ...
    public DespesaCadastroJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Cadastro de Despesa");
        ...
        painelPrincipal.add(labelTipoDespesa, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 30, 30));
        ...
        painelPrincipal.add(labelAsterisco1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 10, 10));
        ...
        painelPrincipal.add(labelAsterisco2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, 20, -1));
        ...
        painelPrincipal.add(labelAsterisco3, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 190, 20, -1));
        ...
        labelAsterisco4.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        labelAsterisco4.setPreferredSize(new java.awt.Dimension(10, 10));
        painelPrincipal.add(labelAsterisco4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 10, 10));
        ...
        labelAsterisco5.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        labelAsterisco5.setPreferredSize(new java.awt.Dimension(10, 10));
        painelPrincipal.add(labelAsterisco5, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 30, 20, -1));
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        ...
        try {
            ...
            d.setDATA(dp.parseDate(ftfData.getText()));
        ...
        d.setDESCRICAO(taDescricao.getText());
        Object o = boxTipoDespesa.getSelectedItem();
        TipoDespesa td = (TipoDespesa) o;
        d.setCDTIPODESPESAFK(td.getCDTIPODESPESA());
        d.setVALOR(Double.parseDouble(tfValor.getText()));
        ...
        try {
            ...
            d.setCDDESPESA(dControle.inserir(d));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
        JOptionPane.showMessageDialog(null, "Cadastro de Despesa realizado com sucesso!", "Aviso", JOptionPane.INFORMATION_MESSAGE);
        this.d = d;
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DespesaCadastroJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DespesaCadastroJDialog dialog = new DespesaCadastroJDialog(new javax.swing.JFrame(), true);
