...
public class VeiculoConsultarTrab extends javax.swing.JDialog {
    ...
    public VeiculoConsultarTrab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void preencheTabela(List<Veiculo> vList) {
        if (vList != null) {
            ...
            for (int i = 0; i < vList.size(); i++) {
                ...
                strTDMat[i][2] = v.getPLACA().substring(0,3) + "-" + v.getPLACA().substring(4,7);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VeiculoConsultarTrab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VeiculoConsultarTrab dialog = new VeiculoConsultarTrab(new javax.swing.JFrame(), true);
