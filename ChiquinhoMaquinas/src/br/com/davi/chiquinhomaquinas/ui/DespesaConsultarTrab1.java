...
public class DespesaConsultarTrab1 extends javax.swing.JDialog {
    ...
    public DespesaConsultarTrab1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void preencheTabela(List<Despesa> dList) {
        if (dList != null) {
            String[] strTVet = new String[]{"Código", "Descrição", "Valor", "Data", "Situação", "Tipo"};
            ...
            for (int i = 0; i < dList.size(); i++) {
                ...
                strTDMat[i][2] = d.getVALOR() + "";
                strTDMat[i][3] = dp.dateToString(d.getDATA());
                if (d.getSITUACAO().equals("P")) {
                    strTDMat[i][4] = "Paga";
                } else if (d.getSITUACAO().equals("N")) {
                    strTDMat[i][4] = "Não Paga";
                }
                try {
                    strTDMat[i][5] = tdControle.consultarPorId(d.getCDTIPODESPESAFK()).getNOME();
                } catch (DaoException e) {
                    JOptionPane.showMessageDialog(this, e.getMessage());
                }
            }
    ...
    private void initComponents() {
        ...
        tfDescricao.setPreferredSize(new java.awt.Dimension(130, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DespesaConsultarTrab1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DespesaConsultarTrab1 dialog = new DespesaConsultarTrab1(new javax.swing.JFrame(), true);
