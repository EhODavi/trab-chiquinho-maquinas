...
public class TipoDespesaConsultarTrab extends javax.swing.JDialog {
    ...
    public TipoDespesaConsultarTrab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoDespesaConsultarTrab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TipoDespesaConsultarTrab dialog = new TipoDespesaConsultarTrab(new javax.swing.JFrame(), true);
