...
public class ClienteFisicoAlterarJDialog extends javax.swing.JDialog {
    ...
    public ClienteFisicoAlterarJDialog(java.awt.Frame parent, boolean modal, int CDPESSOA) {
        super(parent, modal);
        initComponents();

        try {
            ClienteFisicoControle cfControle = new ClienteFisicoControle();
            ClienteFisico cf = cfControle.consultarPorId(CDPESSOA);
            tfNome.setText(cf.getNOME());
            tfTelefoneCelular.setText(cf.getTELEFONE());
            tfEndereco.setText(cf.getENDERECO());
            ftfCPF.setText(cf.getCPF());
            tfEmail.setText(cf.getEMAIL());
            this.cf = cf;
    ...
    private void initComponents() {
        ...
        setTitle("Alteração de Cliente Físico");
        ...
        labelTitulo.setText("Alteração de Cliente Físico");
    ...
    private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
        ...
        this.cf.setNOME(tfNome.getText());
        this.cf.setTELEFONE(tfTelefoneCelular.getText());
        this.cf.setENDERECO(tfEndereco.getText());
        this.cf.setEMAIL(tfEmail.getText());
        this.cf.setCPF(ftfCPF.getText().substring(0, 3) + ftfCPF.getText().substring(4, 7) + ftfCPF.getText().substring(8, 11) + ftfCPF.getText().substring(12, 14));
        try {
            cfControle.alterar(this.cf);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
        JOptionPane.showMessageDialog(null, "Alteração de Cliente Físico realizado com sucesso!", "Aviso", JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteFisicoAlterarJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ClienteFisicoAlterarJDialog dialog = new ClienteFisicoAlterarJDialog(new javax.swing.JFrame(), true, 0);
