...
public class ClienteFisicoVisualizarJDialog extends javax.swing.JDialog {

    public ClienteFisicoVisualizarJDialog(java.awt.Frame parent, boolean modal, int CDPESSOA) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Visualização de Cliente Físico");
        ...
        labelTitulo.setText("Visualização de Cliente Físico");
        ...
        painelPrincipal.add(labelAsterisco3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 100, 10, -1));
        ...
        painelPrincipal.add(labelAsterisco4, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteFisicoVisualizarJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ClienteFisicoVisualizarJDialog dialog = new ClienteFisicoVisualizarJDialog(new javax.swing.JFrame(), true, 0);
