...
public class ServicoCadastroJDialog extends javax.swing.JDialog {
    ...
    public ServicoCadastroJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tfTotal.setText("R$0.0");
        tfTotal1.setText("R$0.0");
        ...
        for (int i = 0; i < cfList.size(); i++) {
            boxPessoa.addItem(cfList.get(i));
        }
        for (int i = 0; i < cjList.size(); i++) {
            boxPessoa.addItem(cjList.get(i));
        }
        ...
        String[][] strSVMat = new String[0][5];
        ...
        String[] strFVet = new String[]{"Código", "Funcionário", "Num. Horas", "Valor/Hora", "Total"};
        String[][] strFMat = new String[0][5];

        DefaultTableModel modelo1 = new javax.swing.table.DefaultTableModel(strFMat, strFVet) {
            @Override
            public boolean isCellEditable(int i, int i1) {
                return false;
            }
        ...
        tabela1.setRowSorter(new TableRowSorter(modelo1));
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Cadastro de Serviço");
    ...
    private void botaoCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoCadastrarActionPerformed
        ...
        Pessoa p = (Pessoa) o;
        s.setCDPESSOAFK(p.getCDPESSOA());
        s.setENDERECO(tfEndereco.getText());
        try {
            s.setDATAINICIO(dp.parseDate(ftfDtInicio.getText()));
            s.setDATAFIM(dp.parseDate(ftfDtFim.getText()));
            s.setDATAPAGAMENTO(dp.parseDate(ftfDataPagamento.getText()));
        } catch (ParseException e) {
            e.printStackTrace();
        }
        ...
        s.setNUMPARCELAS(Integer.parseInt(o.toString()));

        try {
            ServicoControle sControle = new ServicoControle();
            s.setCDSERVICO(sControle.inserir(s));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage());
        }
        ...
        for (int i = 0; i < m.getRowCount(); i++) {
            ...
            sv.setCDSERVICOFK(s.getCDSERVICO());
        ...
        for (int i = 0; i < m1.getRowCount(); i++) {
            ...
            sf.setCDSERVICOFK(s.getCDSERVICO());
        ...
        this.s = s;
        JOptionPane.showMessageDialog(null, "Cadastro de Serviço realizado com sucesso!", "Aviso", JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServicoCadastroJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ServicoCadastroJDialog dialog = new ServicoCadastroJDialog(new javax.swing.JFrame(), true);
